...
try {
    ...
    // Create access log table for provisioning request tracking
    $sql_log = "CREATE TABLE IF NOT EXISTS `quickprovisioner_access_log` (
        `id` INT(11) NOT NULL AUTO_INCREMENT,
        ...
        `resource_type` VARCHAR(20) DEFAULT 'config' COMMENT 'config, wallpaper, ringtone, firmware, phonebook',
        `user_agent` VARCHAR(255) DEFAULT NULL,
        PRIMARY KEY (`id`),
        KEY `mac` (`mac`),
        KEY `timestamp` (`timestamp`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Quick-Provisioner provisioning access log'";
